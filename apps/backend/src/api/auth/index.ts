...
export const authRoute = (): Router => {
    ...
    router.post<{}, {}, UserCreateSchemaType, {
        token: string
    }>("/register", validateSignupHandler(), async (req, res, next) => {
        try {
    ...
    router.post<{}, {}, UserLoginSchemaType, {
        token: string
    }>("/login", validateLoginHandler(), authLocalHandler(), (req, res) => {
